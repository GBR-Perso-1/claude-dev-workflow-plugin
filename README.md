...
| Component  | Items                                                                                                                                                     |
| ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Skills** | `project-init`, `project-session`, `project-requirements`, `project-implement`, `repo-commit`, `repo-terraform`, `repo-git-env`, `repo-ef-sql`, `repo-tidy` |
...
| `/project-implement` | Implement a requirement. Default (`full`): architect → dev → test → review. `draft`: architect + dev only. `quick`: dev only, no ceremony. |
