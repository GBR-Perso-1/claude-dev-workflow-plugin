...
| Component | Items |
|---|---|
| **Skills** | `project-init`, `project-session`, `project-brainstorm`, `project-implement`, `repo-commit`, `repo-terraform`, `repo-git-env`, `repo-ef-sql`, `repo-tidy` |
        ...
        "plugins": [
          {
            ...
            "source": {
              "source": "url",
              "url": "https://github.com/your-org/claude-dev-workflow-plugin.git"
            },
...
| `/project-implement` | Implement a feature using the architect → dev → test → review pipeline |
